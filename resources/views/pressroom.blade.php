...
<div class="bg-[#0a0d14] min-h-screen pb-20">
        ...
        <div class="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="absolute top-0 right-4 sm:right-8 w-full max-w-xs sm:max-w-sm mt-8">
                <div class="glass-search rounded-full flex items-center px-4 py-2.5 shadow-sm border border-white/10">
                    <input type="text" placeholder="Search news..." class="w-full bg-transparent border-none focus:ring-0 text-sm text-slate-300 placeholder-slate-400 outline-none">
            ...
            <div class="max-w-2xl mt-12 sm:mt-0 pt-10">
                <div class="flex items-center gap-4 mb-4">
                    <span class="text-[10px] font-bold text-[#d4af37] uppercase tracking-[0.2em]">BOOKS ACADEMY NEWSROOM</span>
    ...
    <div class="relative z-20 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-24 mb-16">
        <div class="bg-[#0f131a]/95 backdrop-blur-md rounded-[2rem] shadow-[0_20px_40px_rgba(10, 13, 20,0.05)] border border-white/5 p-6 sm:p-8 flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            ...
            <div class="w-full timeline-dotted-line flex justify-between items-start">
                ...
                <div class="stat-node text-center px-4 flex flex-col items-center group">
                    <div class="w-12 h-12 rounded-full bg-[#0f131a] border border-white/5 flex items-center justify-center mb-3 group-hover:border-[#d4af37] group-hover:shadow-md transition-all">
                        <!-- Book Icon -->
                ...
                <div class="stat-node text-center px-4 flex flex-col items-center group">
                    <div class="w-12 h-12 rounded-full bg-[#0f131a] border border-white/5 flex items-center justify-center mb-3 group-hover:border-[#d4af37] group-hover:shadow-md transition-all">
                        <!-- Trophy Icon -->
                        <svg class="w-6 h-6 text-[#d4af37]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path></svg>
                    </div>
                ...
                <div class="stat-node text-center px-4 flex flex-col items-center group">
                    <div class="w-12 h-12 rounded-full bg-[#0f131a] border border-white/5 flex items-center justify-center mb-3 group-hover:border-[#d4af37] group-hover:shadow-md transition-all">
                        <!-- Clipboard Icon -->
                        <svg class="w-6 h-6 text-[#d4af37]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path></svg>
                    </div>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center gap-6 mb-10">
            ...
            <div class="flex items-center gap-2 overflow-x-auto w-full sm:w-auto pb-2 sm:pb-0 scrollbar-hide">
                <button class="px-5 py-2 rounded-full bg-[#d4af37] text-[#0a0d14] text-[11px] font-bold tracking-wider shrink-0">All</button>
                <button class="px-5 py-2 rounded-full bg-[#0f131a] border border-white/10 text-slate-300 hover:text-[#0a0d14] text-[11px] font-bold tracking-wider shrink-0 transition-colors">Publishing</button>
                <button class="px-5 py-2 rounded-full bg-[#0f131a] border border-white/10 text-slate-300 hover:text-[#0a0d14] text-[11px] font-bold tracking-wider shrink-0 transition-colors">Awards</button>
                <button class="px-5 py-2 rounded-full bg-[#0f131a] border border-white/10 text-slate-300 hover:text-[#0a0d14] text-[11px] font-bold tracking-wider shrink-0 transition-colors">Book Launches</button>
                <button class="px-5 py-2 rounded-full bg-[#0f131a] border border-white/10 text-slate-300 hover:text-[#0a0d14] text-[11px] font-bold tracking-wider shrink-0 transition-colors">Events</button>
                <button class="px-5 py-2 rounded-full bg-[#0f131a] border border-white/10 text-slate-300 hover:text-[#0a0d14] text-[11px] font-bold tracking-wider shrink-0 transition-colors">Marketing</button>
                <button class="px-5 py-2 rounded-full bg-[#0f131a] border border-white/10 text-slate-300 hover:text-[#0a0d14] text-[11px] font-bold tracking-wider shrink-0 transition-colors">Authors</button>
                <button class="px-5 py-2 rounded-full bg-[#0f131a] border border-white/10 text-slate-300 hover:text-[#0a0d14] text-[11px] font-bold tracking-wider shrink-0 transition-colors">Collaborations</button>
            </div>

            <!-- Sort Dropdown -->
            <div class="shrink-0">
                <select class="appearance-none bg-[#0f131a] border border-white/10 rounded-full px-5 py-2 pr-8 text-[11px] font-bold text-slate-300 outline-none cursor-pointer" style="background-image: url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%22292.4%22%20height%3D%22292.4%22%3E%3Cpath%20fill%3D%22%23475569%22%20d%3D%22M287%2069.4a17.6%2017.6%200%200%200-13-5.4H18.4c-5%200-9.3%201.8-12.9%205.4A17.6%2017.6%200%200%200%200%2082.2c0%205%201.8%209.3%205.4%2012.9l128%20127.9c3.6%203.6%207.8%205.4%2012.8%205.4s9.2-1.8%2012.8-5.4L287%2095c3.5-3.5%205.4-7.8%205.4-12.8%200-5-1.9-9.2-5.5-12.8z%22%2F%3E%3C%2Fsvg%3E'); background-repeat: no-repeat; background-position: right .7em top 50%; background-size: .65em auto;">
        ...
        <div class="grid grid-cols-12 gap-6 mb-16">
                ...
                <div class="absolute inset-0 p-8 sm:p-10 flex flex-col justify-between">
                    <div>
                        ...
                        <div class="flex items-center gap-3 text-[10px] font-bold text-white uppercase tracking-wider mb-4 opacity-90">
                            ...
                            <span>•</span>
                            <span class="bg-red-500 px-2 py-0.5 rounded text-[9px] flex items-center gap-1"><span class="w-1.5 h-1.5 rounded-full bg-[#0f131a] animate-pulse"></span> LIVE</span>
                        </div>
                    ...
                    <div>
                        <button class="bg-gradient-to-r from-[#d4af37] to-[#eab308] text-white px-6 py-2.5 rounded-full text-[11px] font-bold tracking-widest uppercase hover:-translate-y-0.5 transition-transform flex items-center gap-2">
                            Read Story
            ...
            <div class="col-span-12 md:col-span-6 lg:col-span-4 bg-[#0f131a] rounded-[1.5rem] overflow-hidden border border-white/5 shadow-sm hover:shadow-lg transition-shadow group flex flex-col cursor-pointer">
                ...
                <div class="p-6 flex flex-col flex-1">
                    ...
                    <h3 class="text-lg font-serif font-bold text-white mb-2 leading-snug group-hover:text-[#d4af37] transition-colors">
                        Annual Writers Retreat & Masterclass Series
                    </h3>
                    <p class="text-[13px] text-slate-400 leading-relaxed line-clamp-3 mb-6 flex-1">
            ...
            <!-- Article 1 -->
            <div class="col-span-12 sm:col-span-6 lg:col-span-3 bg-[#0f131a] rounded-[1.5rem] overflow-hidden border border-white/5 shadow-sm hover:shadow-lg transition-shadow group flex flex-col cursor-pointer">
                ...
                <div class="p-5 flex flex-col flex-1">
                    <span class="text-[9px] font-bold text-[#d4af37] uppercase tracking-widest mb-2">AWARDS</span>
                    <div class="flex items-center gap-2 text-[10px] text-slate-400 font-medium mb-2">
                        <span>May 15, 2026</span>
                        <span>•</span>
                        <span>4 min read</span>
                    </div>
                    <h3 class="text-base font-serif font-bold text-white mb-2 leading-tight group-hover:text-[#d4af37] transition-colors">
                        Independent Penholder Awards Finalists Released
                    </h3>
                    <p class="text-xs text-slate-400 leading-relaxed line-clamp-3 mb-4 flex-1">
            ...
            <div class="col-span-12 sm:col-span-6 lg:col-span-3 bg-[#0f131a] rounded-[1.5rem] overflow-hidden border border-white/5 shadow-sm hover:shadow-lg transition-shadow group flex flex-col cursor-pointer">
                ...
                <div class="p-5 flex flex-col flex-1">
                    ...
                    <h3 class="text-base font-serif font-bold text-white mb-2 leading-tight group-hover:text-blue-500 transition-colors">
            ...
            <div class="col-span-12 sm:col-span-6 lg:col-span-3 bg-[#0f131a] rounded-[1.5rem] overflow-hidden border border-white/5 shadow-sm hover:shadow-lg transition-shadow group flex flex-col cursor-pointer">
                ...
                <div class="p-5 flex flex-col flex-1">
                    <span class="text-[9px] font-bold text-[#d4af37] uppercase tracking-widest mb-2">BOOK LAUNCHES</span>
                    <div class="flex items-center gap-2 text-[10px] text-slate-400 font-medium mb-2">
            ...
            <div class="col-span-12 sm:col-span-6 lg:col-span-3 bg-[#0f131a] rounded-[1.5rem] overflow-hidden border border-white/5 shadow-sm hover:shadow-lg transition-shadow group flex flex-col cursor-pointer">
                ...
                <div class="p-5 flex flex-col flex-1">
                    ...
                    <h3 class="text-base font-serif font-bold text-white mb-2 leading-tight group-hover:text-emerald-500 transition-colors">
        ...
        <div class="w-full bg-[#d4af37] rounded-[2rem] overflow-hidden relative flex flex-col md:flex-row items-center p-8 sm:p-12 lg:p-16 mb-8 shadow-2xl">
            <!-- Background effects -->
            ...
            <div class="relative z-20 max-w-lg">
                <span class="text-[10px] font-bold text-[#d4af37] uppercase tracking-widest mb-3 block">EXPLORE MORE</span>
                ...
                <div class="flex flex-wrap items-center gap-4">
                    <button class="bg-gradient-to-r from-[#d4af37] to-[#eab308] text-white px-6 py-3 rounded-full text-xs font-bold tracking-widest uppercase hover:-translate-y-0.5 transition-transform flex items-center gap-2">
                        Browse Pressroom
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                    </button>
                    <button class="text-white hover:text-[#d4af37] text-xs font-bold tracking-widest uppercase transition-colors flex items-center gap-2 px-4 py-3">
